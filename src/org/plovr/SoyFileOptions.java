...
final class SoyFileOptions {
  ...
  public int hashCode() {
    return Objects.hashCode(
        pluginModuleNames, useClosureLibrary, isUsingInjectedData, langBundle);
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equal(this.pluginModuleNames, that.pluginModuleNames) &&
        ...
        Objects.equal(this.langBundle, that.langBundle);
  }
}
